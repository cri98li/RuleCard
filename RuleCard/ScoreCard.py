...
class ScoreCard(ClassifierMixin, BaseEstimator):
    ...
    @classmethod
    def _get_all_rules(cls, clf: RuleCardGAM, X):
        rules = []
    ...
    @classmethod
    def from_rulecard(cls, clf:RuleCardGAM, X, PDO=20, odds0=50, score0=600):
